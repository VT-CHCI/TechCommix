	...
	if(!window.svgEditor) window.svgEditor = function($) {
		...
		var defaultPrefs = {
			...
			curConfig = {
				...
				initOpacity: 1,
				imgPath: '_edit/editor/images/',
				langPath: '_edit/editor/locale/',
				extPath: '_edit/editor/extensions/',
				jGraduatePath: '_edit/editor/jgraduate/images/',
...
// 				var opacity = (picker == 'stroke' ? $('#stroke_opacity') : $('#fill_opacity'));
			...
			setTimeout(function() {
				svgCanvas.embedImage('_edit/editor/images/logo.png', function(datauri) {
					if(!datauri) {
						// Disable option
